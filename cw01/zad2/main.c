...
int execute(char** args, int* index, int argc, struct find_arr* find_array){   // if execute return 1 else 0
    int i = *index;
...
int main(int argc, char** argv){
    ...
    struct find_arr *find_array = create((int)(strtol(argv[1],'\0', 10)));
